...
public class ApplicationConfig extends SpringConfig {
    ...
    public String applicationVersion() {
        LOGGER.info("Application version found {}", super.getProperty(APPLICATION_VERSION, String.class));
        return super.getProperty(APPLICATION_VERSION, String.class);
    }


    /**
     * Search a variable in the JNDI dictionary. If no value is found, default it from the properties file.
     *
    ...
    private String getStringVariable(String name) {
        try {
            ...
            LOGGER.info("Binding JNDI {} gave null (Naming exception). Returning property {}", name, super.getProperty(name, String.class));
    ...
    public String schemaName() {
        ...
        if (jndiFoundPath == null || "".equals(jndiFoundPath)) {
            LOGGER.info("Binding JND Database schema Name gave null. Returning property {}", super.getProperty("database.schema", String.class));
    ...
    public String datasourceJndiName() {
        LOGGER.info("database JNDI name set to {}", super.getProperty(DATASOURCE_JNDI_NAME, String.class));
