...
/**
 * Global Spring configuration class for all Spring conf classes. Allow them to easily
 * access properties and beans.
 *
...
public class SpringConfig implements ApplicationContextAware {
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(SpringConfig.class.getCanonicalName());
